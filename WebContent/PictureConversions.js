...
//	var dwtCr = dwt2D(crMatrix, 4, 4);
	...
	var compressedYLustig = compressHigh(dwtY11, threshold);
...
function decompressImage(compressedMatrix, threshold) {
	...
	*/
	...
	decompressedYPart = arrayToMatrix16(decompressedY, paddedHeight, paddedWidth);
	decompressedCbPart = arrayToMatrix16(decompressedCb, paddedHeight, paddedWidth);
	decompressedCrPart = arrayToMatrix16(decompressedCr, paddedHeight, paddedWidth);
